  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'data-[active=true]:bg-primary data-[current=true]:text-white data-[current=true]:bg-primary data-[active=true]:border-primary data-[active=true]:text-primary-foreground',
